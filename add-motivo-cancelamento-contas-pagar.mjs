...
try {
  await pool.request().query(`
    IF COL_LENGTH('KS0003.KS00004', 'MOTIVOCANCELAMENTO') IS NULL
    BEGIN
      ALTER TABLE KS0003.KS00004
        ADD MOTIVOCANCELAMENTO NVARCHAR(500) NULL;
    END
  `);
  console.log("Coluna MOTIVOCANCELAMENTO verificada/criada em KS0003.KS00004.");
} finally {
  await pool.close();
}
